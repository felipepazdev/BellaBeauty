            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16">
                <div>
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--accent-cyan)]/10 border border-[var(--accent-cyan)]/20 text-[var(--accent-cyan)]">
                ...
                <div className="flex items-center gap-3 self-start md:self-center">
                    <button 
                        ...
                        className="btn-cyan h-14 px-8 shadow-[var(--accent-cyan-glow)]"
                    >
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-40 gap-6 text-center">
                    <div className="relative">
                        <div className="w-16 h-16 border-2 border-[var(--accent-cyan)]/20 rounded-full animate-ping absolute inset-0" />
                        <div className="w-16 h-16 border-2 border-t-[var(--accent-cyan)] border-r-transparent border-b-[var(--accent-cyan)] border-l-transparent rounded-full animate-spin relative z-10" />
                    </div>
                        ...
                        return (
                            <div key={niche.id} className="relative group/niche-section">
                                ...
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    >
                                        <div className={`w-12 h-12 rounded-2xl flex items-center justify-center bg-white/5 border border-white/10 text-[var(--accent-cyan)] transition-all duration-500 ${isNicheExpanded ? 'rotate-0 shadow-lg shadow-[var(--accent-cyan-glow)]' : '-rotate-90 opacity-40'}`}>
                                            <ChevronDown size={24} />
                                        </div>
                                        <div>
                                            <h2 className="text-4xl font-serif font-bold tracking-tight text-white group-hover/niche-section:text-[var(--accent-cyan)] transition-colors">
                                                {niche.name}
                                            </h2>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <button 
                                            ...
                                            className="px-5 py-2.5 rounded-xl bg-[var(--accent-cyan)]/10 border border-[var(--accent-cyan)]/20 text-[10px] font-black text-[var(--accent-cyan)] uppercase tracking-widest hover:bg-[var(--accent-cyan)] hover:text-[#1a1505] transition-all duration-300"
                                        >
                                            + Categoria
                                        </button>
                                    ...
                                    <div className="space-y-12 animate-fade-in pl-4 md:pl-8 border-l border-white/5 ml-6">
                                        {!niche.categories?.length ? (
                                            <div className="py-12 px-8 rounded-3xl border border-dashed border-white/5 flex flex-col items-center gap-4 text-center">
                                                ...
                                                <button onClick={() => openNewCategory(niche.id)} className="text-[9px] font-black uppercase tracking-widest text-[var(--accent-cyan)] py-1 underline">Adicionar categoria agora</button>
                                            </div>
                                        ) : (
                                                    ...
                                                    <div key={cat.id} className="relative group/category">
                                                        <div className="flex items-center justify-between mb-8 group/cat-header">
                                                            ...
                                                            >
                                                                ...
                                                                <h3 className="text-xl font-bold tracking-tight text-white group-hover/category:text-[var(--accent-cyan)] transition-colors">
                                                                    {cat.name}
                                                                </h3>
                                                            ...
                                                            <div className="flex items-center gap-4">
                                                                <button 
                                                                    ...
                                                                    className="text-[9px] font-black tracking-[0.2em] text-slate-500 hover:text-[var(--accent-cyan)] uppercase transition-all"
                                                                >
                                                                    + ADICIONAR SERVIÇO
                                                                </button>
                                                                    ...
                                                                    catServices.map(s => (
                                                                        ...
                                                                        >
                                                                            <div className="flex items-start justify-between">
                                                                                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 border border-white/5 flex items-center justify-center text-[var(--accent-cyan)] group-hover/card-service:scale-110 transition-transform duration-500">
                    ...
                    >
                                ...
                                <div className="space-y-6">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <input 
                                            ...
                                            className="h-14 bg-white/5 border border-white/10 rounded-2xl px-5 text-white focus:border-[var(--accent-cyan)]/50 transition-all outline-none font-bold" 
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="relative">
                                                <input 
                                                    ...
                                                    className="h-14 w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-5 text-white focus:border-[var(--accent-cyan)]/50 transition-all outline-none font-bold" 
                                                    placeholder="60" 
                                                />
                                ...
                                <div className="space-y-6">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <select 
                                            ...
                                            className="h-14 bg-white/5 border border-white/10 rounded-2xl px-5 text-white focus:border-[var(--accent-cyan)]/50 transition-all outline-none font-bold appearance-none"
                                        >
                        ...
                        <div className="px-10 py-8 bg-black/40 border-t border-white/5 flex gap-4">
                            ...
                            <button 
                                ...
                                disabled={saving}
                                className="flex-1 h-14 btn-cyan shadow-[var(--accent-cyan-glow)]"
                            >
