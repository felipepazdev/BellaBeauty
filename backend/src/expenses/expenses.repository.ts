...
export class ExpensesRepository {
    ...
    async create(data: Prisma.ExpenseUncheckedCreateInput, trx?: Prisma.TransactionClient) {
        const client = trx || this.prisma;
    ...
    async update(id: string, data: Prisma.ExpenseUpdateInput, trx?: Prisma.TransactionClient) {
        const client = trx || this.prisma;
