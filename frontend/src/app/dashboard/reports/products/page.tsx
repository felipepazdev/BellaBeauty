        ...
        <div style={{ width: '100%', background: 'var(--bg-main)', minHeight: '100%', color: 'var(--text-primary)' }}>
            ...
            <div className="mb-6 mt-2 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-[32px] font-serif font-extrabold tracking-tight text-[#111827]">Produtos</h1>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                <div className="lg:col-span-1 bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col items-center justify-center min-h-[300px]">
                    <Package size={48} strokeWidth={1} className="text-gray-300 mb-4" />
                    <h3 className="text-[16px] font-extrabold text-[#111827] mb-1">Produtos Mais Vendidos</h3>
