...
export class FinanceController {
    ...
    @Roles('ADMIN', 'MANAGER')
    @ApiOperation({ summary: 'Lançar uma despesa especificamente (Aluguel, Materiais, Salários)' })
    @Post('expense')
    ...
    @Post('withdraw')
    async withdraw(@Req() req, @Body() data: { amount: number; description: string }) {
        return this.financeService.createWithdrawal(req.user.salonId, data.amount, data.description);
    }
}