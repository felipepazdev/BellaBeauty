        ...
        <div style={{ width: '100%', background: 'var(--bg-main)', minHeight: '100%', color: 'var(--text-primary)' }}>
            ...
            <div className="mb-6 mt-2 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-[32px] font-serif font-extrabold tracking-tight text-[#111827]">Serviços</h1>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div className="lg:col-span-1 bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col items-center justify-center min-h-[300px]">
                    <PieChart size={48} strokeWidth={1} className="text-gray-300 mb-4" />
                    <h3 className="text-[16px] font-extrabold text-[#111827] mb-1">Serviços Mais Lucrativos</h3>
                    <p className="text-[13px] text-gray-500 text-center">Geração de gráficos em desenvolvimento.</p>
                </div>

                <div className="lg:col-span-2 bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                    <div className="p-5 border-b border-gray-200 flex justify-between items-center">
                        <h2 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text-primary)' }}>Desempenho de Serviços</h2>
                    ...
                    <div className="overflow-x-auto max-h-[400px] overflow-y-auto">
                        <table style={{ width: '100%', textAlign: 'left', borderCollapse: 'collapse' }}>
                            ...
                            <tbody>
                                {records.map(record => {
                                    const percentage = totalValue > 0 ? Math.round((record.value / totalValue) * 100) : 0;
                                    return (
                                        <tr key={record.id} className="hover:bg-[#f8f9fa] transition-colors cursor-pointer group">
                                            ...
                                            <td className="p-4 text-[13px] font-bold text-gray-500 text-right">{percentage}%</td>
                                        </tr>
                                    );
                                })}
                            </tbody>
